...
const RunJoi = Joi.string().min(9).max(10).regex(/^\d{7,8}-[0-9kK]$/).label('Número de Rol Único Nacional')
    .description('Correlativo con verificador, sin puntos, con guión').example('1234567-k')
...
const CategoriaServicioJoi = Joi.string().valid(['BUSES', 'COLECTIVOS', 'PRIVADO', 'TAXIS'])

module.exports = {
    RutJoi,
    IdJoi,
    CodigoRegionJoi,
    CategoriaServicioJoi,

    RespServiciosAutorizadosJoi,
    SolicitudServicioJoi,
