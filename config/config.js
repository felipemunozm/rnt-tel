/** 
 * Configuraciones por defecto para el ambiente, solo para configuración de aplicación.
 * Para variables de ambiente usar process.env de modo de definir esas varaibles dependiendo el sistema 
 * en donde se montará el servicio (variables de entorno configurables por ambiente).
 * 
 * Este archivo contiene la configuración común que puede ser sobreescrita por los archivos de ambiente.
 * Información sensible debe ser agregada como configuración de ambiente. 
 */
module.exports = {
    env: 'default',
    ...
    validacionRules: {
        inscripcionVehiculo: {
            ...
            validaAntiguedadRule: {
                conditions: {
                    all: [{ //validacion de antiguedad con antiguedad permitida por Norma del folio/region
                        fact: 'registrocivil',
                        path: '.antiguedad',
            ...
            validaRTRule: {
                conditions: {
                    all: [{ //validacion de resultado de RT
                            fact: 'sgprt',
                            path: '.resultadoRT',
                            operator: 'equal',
                            value: 'Aprobada'
            ...
            buses: {
                validaInscripcionRNTRule: {
                    conditions: {
                        any: [{ //valida que vehiculo no exista en RNT
                                fact: 'rnt',
                                path: '.estado',
                                operator: 'equal',
                                value: '0'
