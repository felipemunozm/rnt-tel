...
const InputValidaFlota = require('../model/InputValidaFlota')
...
module.exports = {
     ...
     * 
     * getAutorizadoPorEmpresaAndSolicitanteInscripcionServicioEscolar
     */
    serviciosAutorizadosInscripcionRepresentante: (tipoVehiculo, codigoRegion, rutEmpresa, rutSolicitante) => {
        ...
        let servicios = escolarRepository.serviciosAutorizadosInscripcionRepresentante(codigoRegion, rutEmpresa, rutSolicitante, idtramite)
